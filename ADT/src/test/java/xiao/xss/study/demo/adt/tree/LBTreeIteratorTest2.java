...
public class LBTreeIteratorTest2 {
    ...
    public static void beforeClass() {
        LinkedBinaryTree<String> C = new LinkedBinaryTree<>("C");
        ...
        LinkedBinaryTree<String> H = new LinkedBinaryTree<>("H", K, J);
        LinkedBinaryTree<String> G = new LinkedBinaryTree<>("G", H, null);

        LinkedBinaryTree<String> I = new LinkedBinaryTree<>("I");
        LinkedBinaryTree<String> F = new LinkedBinaryTree<>("F", I, G);
        LinkedBinaryTree<String> E = new LinkedBinaryTree<>("E", null, F);

        LinkedBinaryTree<String> D = new LinkedBinaryTree<>("D", E, null);
        LinkedBinaryTree<String> A = new LinkedBinaryTree<>("A", B, D);
